    ...
    public class CardMgr : MonoBehaviour
    {
        ...
        public GameObject firstCardToHide; //BJ
        ...
        public Card generateCard() //Poker & Blackjack
        {
        ...
        public void handlePredealBJ() //Blackjack
        {
            ...
            Debug.Log(handDealerBJ[0].rank + " : " + handDealerBJ[1].rank);
            if ((handDealerBJ[0].rank + handDealerBJ[1].rank) == 21)
            {
                GameMgr.inst.isDealerDone = true;
                GameMgr.inst.dealerInstaBJ = true;
        ...
        public void handleDealerPostGame () //Blackjack
        {
            ...
            else if (GameMgr.inst.checkDealerHandValue() > 21) //dealer busts, postdealing for dealer is done
            {
                GameMgr.inst.isDealerDone = true;
                GameMgr.inst.dealerBust = true;
            }
            else if (GameMgr.inst.checkDealerHandValue() >= 17) //dealer has to stand
            {
                GameMgr.inst.isDealerDone = true;
            }
        }

        public void handleCleanup() //Poker & BJ
        {
            if (GameMgr.inst.isPoker)
            {
        ...
        public void resetMiscFlags() //Blackjack
        {
            GameMgr.inst.dealerInstaBJ = false;
        ...
        public void handlePredeal() //Poker
        {
            /*
                    //Testing For manually setting cards in hand.
                    Card card1 = deck[11];
                    hand[0] = card1;
                    Card card2 = deck[34];
                    hand[1] = card2;
        ...
        public void revealDealerDownCard() //Blackjack
        {    
